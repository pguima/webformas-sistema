...
return [
    ...
    'campaigns' => [
        ...
        'profile_card' => [
            'title' => 'Campañas/Anuncios (Integración)',
            'description' => 'Configura los IDs para cargar los datos del dashboard.',
        ],

        'client_tab' => [
            'title' => 'Campañas/Anuncios',
            'subtitle' => 'Dashboard de campañas/anuncios de :name',
        ],

        'dashboard' => [
            'title' => 'Dashboard de campañas/anuncios',
            ...
            'missing_ids' => 'Completa los IDs de Google (Manager/Client Customer ID) y/o el Meta Ads Account ID en el perfil del cliente para cargar el dashboard.',
