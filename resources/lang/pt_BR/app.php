...
return [
    ...
    'campaigns' => [
        'title' => 'Campanhas',
        'subtitle' => 'Gerencie as integrações de campanhas por cliente.',
        'search_placeholder' => 'Buscar...',
        'per_page' => 'Por página',
        'no_results' => 'Nenhum registro encontrado para ":search".',
        ...
        'table' => [
            ...
            'conversions_rate' => 'Taxa de conversão',
            'cost' => 'Custo',
        ],
        ...
        'offcanvas' => [
            ...
            'edit_description' => 'Atualize os IDs de integração.',
        ],
        ...
        'dashboard' => [
            ...
            'refresh' => 'Atualizar',
            'loading' => 'Carregando...',
            'table_title' => 'Campanhas',
            'top_title' => 'Top campanhas',
            'top_subtitle' => 'Cliques vs impressões',
            'status_title' => 'Status',
            'status_subtitle' => 'Distribuição',
            'cost_title' => 'Maiores Gastos',
            'cost_subtitle' => 'Top campanhas por custo',
            'channel_title' => 'Tipos de Canal',
            'channel_subtitle' => 'Distribuição por tipo de canal',
            'conversions_title' => 'Conversões e Taxa',
            ...
            'series' => [
                'clicks' => 'Cliques',
                'impressions_100' => 'Impressões / 100',
                'cost' => 'Custo (R$)',
            ],
            'status' => [
                'active' => 'Ativas',
        ...
        'messages' => [
            ...
            'error_not_found' => 'Campanha não encontrada.',
            'create_disabled' => 'A criação não está disponível nesta página.',
        ],
    ],
